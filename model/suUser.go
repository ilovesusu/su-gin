...
//	//_ = db.SuDB.AutoMigrate(&SuUser{}) //用户表
//}
//
//func (user *SuUser) Create(registerParam RegisterParam) (msg string, err error) {
...
//}
//
//func (user *SuUser) Retrieve() (msg string, err error) {
//	panic("implement me")
//}
//
//func (user *SuUser) Update() (msg string, err error) {
//	panic("implement me")
//}
//
//func (user *SuUser) Delect() (msg string, err error) {
//	panic("implement me")
//}
//
//func (model *SuUser) GetUserForID(id int) (err error) {
...
//}
//
//func (model *SuUser) GetUserForUserName(username string) (err error) {
